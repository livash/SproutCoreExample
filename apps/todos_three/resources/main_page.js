  ...
  mainPane: SC.MainPane.design({
    ...
    newTodoField: SC.View.design({
      ...
      button: SC.ButtonView.design({
        ...
        layout: { centerY; 0, height: 30, height: 12, zIndex: 100 },
        title: 'Add',
        action: 'addTodo',
    ...
    todosList: SC.ScrollView.design({
      ...
      contentView: SC.ListView.design({
        contentBinding: SC.Binding.ondeWay('TodosThree.todosController'),
        rowHeight: 36,
    ...
    footer: SC.Toolbar.View.design({
      ...
      clearCompletedTodos: SC.ButtonView.design(SC.AutoResize, {
        ...
        isEnabledBinding: SC.Binding.oneWay('TodosThree.completedTodosController.length'),
